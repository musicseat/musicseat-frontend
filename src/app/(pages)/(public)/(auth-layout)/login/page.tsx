    ...
    <>
      ...
      <form className="space-y-6 px-4">
        ...
        <button
          ...
          className="w-full bg-black text-neutral-50 font-medium text-lg py-4 rounded-full hover:opacity-90 active:scale-[0.98] transition-all shadow-medium cursor-pointer"
        >
          Fazer Login
        </button>
        ...
        <div className="relative flex items-center py-4">
          ...
          <span className="shrink mx-4 text-sm text-neutral-400">
            ou continue com
          </span>
          <div className="grow border-t border-neutral-600"></div>
        </div>
        ...
        <div className="space-y-3">
          <button
            type="button"
            className="w-full bg-neutral-700 text-neutral-50 font-medium text-base py-3 rounded-full hover:bg-neutral-600 active:scale-[0.98] transition-all flex items-center justify-center gap-3 cursor-pointer"
          >
